...
public class TC03_03_TakamolE2E_MyRoleModelProgram {
	...
	public void testCaseFlow() throws InterruptedException, IOException {
        ...
        CommonWebActions.webClick("MMP_Link");
        AUT.validateBreadCrumb("MMP_Header", "MMP header ");
        Thread.sleep(1000);
        Takamol.validateMMPPageScreen();
        Takamol.uploadImageBySendKeys("CV", "Test.pdf");
       // Takamol.attachAndVerifyFiles("Test.pdf");
        ...
        Thread.sleep(1000);
        AUT.validateBreadCrumb("Hosting_MMPHeader", "Hoasting MMP header ");
        Thread.sleep(1000);
        Takamol.selectMMRHostingDetails();
