...
public class TC12_TakamolE2E_FinancialAidRequest {
	...
	public void testCaseFlow() throws InterruptedException, IOException {
        ...
        Thread.sleep(1000);
        CommonWebActions.getWebElement("DashboardSearch").sendKeys("Financial Aid Request Service For Beneficiaries With Disabilities");
        CommonWebActions.webClick("FinancialAidRequestServiceLink");
        AUT.validateBreadCrumb("FinancialAidRequestServiceLink_Header", "Financial Aid RequestService Link header ");
        CommonWebActions.webClick("MedicalBeneficiary_dropdown");
        Thread.sleep(1000);
        CommonWebActions.webClick("MedicalBeneficiary_dropdownValue");
        Takamol.selectFinancialAidRequestServiceDetails();
      ...
      //  Takamol.verifyMedicalDeviceRequestCreatedOrNot();
		...
		Thread.sleep(2000);
		Takamol.FinancialAidapproveRequestSubsidyEmployee();
		Thread.sleep(2000);
