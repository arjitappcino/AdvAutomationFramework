...
public class TC03_01_TakamolE2E_FosterFamiliesProgram {
	...
	public void testCaseFlow() throws InterruptedException, IOException {
        ...
        CommonWebActions.webClick("FosterFamiliesProgram_Link");
        AUT.validateBreadCrumb("FosterFamiliesProgram_Header", "Foster Families Program header ");
        Thread.sleep(1000);
        Takamol.selectFosterFamilyDetailsForIncubation();
        AUT.validateBreadCrumb("EvidenceHeader", "Evidence header ");
        Thread.sleep(1000);
		CommonWebActions.webClick("NextButton");
        AUT.validateBreadCrumb("MedicalHeader", "Medical docs header ");
        Takamol.uploadDocsForFoasterFamily();
        ...
        Thread.sleep(1000);
        CommonWebActions.webClick("UnderTakingCheckBoxFoster");
        Thread.sleep(1000);
